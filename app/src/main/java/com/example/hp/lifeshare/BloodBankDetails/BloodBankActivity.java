...
public class BloodBankActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
       /* // Handle navigation view item clicks here.
        int id = item.getItemId();
            if (id == R.id.currentDetails) {

        } else if (id == R.id.updateDetails) {

        } else if (id == R.id.issueBlood) {

        } else if (id == R.id.history) {

        } else if (id == R.id.nearByUsers) {
    ...
    private void displaySelectedScreen(int itemId) {
        ...
        switch (itemId) {
            case R.id.currentDetails:
                fragment = new currentDetails();
                break;
            case R.id.updateDetails:
                fragment = new updateDetails();
                break;
            case R.id.issueBlood:
